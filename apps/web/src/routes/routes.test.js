...
describe("route rendering", () => {
    ...
    it("renders import route with AI health summary", () => {
        const markup = renderToStaticMarkup(_jsx(MemoryRouter, { children: _jsx(ImportRoute, {}) }));
    ...
    it("renders progress route counts and failures", () => {
        const markup = renderToStaticMarkup(_jsx(MemoryRouter, { children: _jsx(ProgressRoute, {}) }));
    ...
    it("renders group detail route review state", () => {
        const markup = renderToStaticMarkup(_jsx(MemoryRouter, { initialEntries: ["/groups/group_1?job=job_123"], children: _jsx(Routes, { children: _jsx(Route, { path: "/groups/:groupId", element: _jsx(GroupDetailRoute, {}) }) }) }));
    ...
    it("renders global review and export routes", () => {
        const reviewMarkup = renderToStaticMarkup(_jsx(MemoryRouter, { children: _jsx(ReviewRoute, {}) }));
        const exportMarkup = renderToStaticMarkup(_jsx(MemoryRouter, { children: _jsx(ExportRoute, {}) }));
    ...
    it("renders settings route with threshold controls", () => {
        const markup = renderToStaticMarkup(_jsx(MemoryRouter, { children: _jsx(SettingsRoute, {}) }));
